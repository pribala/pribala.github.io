# import the fresh_tomatoes module that helps to generate a website
...
life_of_pets = media.Movie("The Secret Life of Pets",
                           "That's when the pets of every stripe, fur and feather \
                           begin their own nine-to-five routine.",
...
finding_dory = media.Movie("Finding Dory",
                           "'Finding Dory' reunites the friendly-but-forgetful blue \
                           tang fish with her loved ones.",
                           "https://upload.wikimedia.org/wikipedia/en/thumb/3/3e/Finding_Dory.jpg/220px-Finding_Dory.jpg",  # noqa
...
angry_bird = media.Movie("The Angry Birds Movie",
                         "The Angry Birds Movie, we'll finally find out why the \
                         birds are so angry.",
...
minions = media.Movie("Minions",
                      "Minions live to serve, but find themselves working for a \
                      continual series of unsuccessful masters.",
...
inside_out = media.Movie("Inside Out",
                         "The film is set in the mind of a young girl where five \
                         personified emotions try to lead her through life.",
...
jungle_book = media.Movie("The Jungle Book",
                          "Raised by a family of wolves since birth, Mowgli must \
                          leave the only home he's ever known when the \
                          fearsome tiger Shere Khan unleashes \
                          his mighty roar.",
                          "https://upload.wikimedia.org/wikipedia/en/thumb/a/a4/The_Jungle_Book_(2016).jpg/220px-The_Jungle_Book_(2016).jpg",  # noqa
...
frozen = media.Movie("Frozen",
                     ...
                     his reindeer sidekick to find Anna's sister.",
...
peanuts_movie = media.Movie("The Peanuts Movie",
                            "Life always seems complicated for good ol' \
                            Charlie Brown,the boy who always tries his best \
                            against seemingly impossible odds.",
                            "https://upload.wikimedia.org/wikipedia/en/7/77/Peanuts_2015.jpg",  # noqa
                            "https://youtu.be/qI34nBlJxP8",
                            "11/06/2015",
                            "Steve Martino")

# create a python list 'movies' for the instances of the Movie class created.
# The list object will be passed as argument to the open_movies_page function

movies = [zootopia, hotel_transylvania_2, life_of_pets, finding_dory,
          angry_bird, minions, inside_out, jungle_book, frozen,
          peanuts_movie]

""" calling the open_movies_page function in the fresh_tomatoes module
with the list of movies as argument
The open_movies_page function creates an HTML file which visualizes the list
